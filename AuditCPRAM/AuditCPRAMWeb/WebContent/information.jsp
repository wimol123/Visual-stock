...
<body>
	...
	<div class="imgLoader"></div>
         ...
         <div class="col-md-12">
             ...
             <div class="portlet light ">
				<div class="portlet-title">
                    ...
                    <div class="actions">
	                    <a   class="btn sbold green" href="information_form.jsp"> สร้างข้อกำหนด/ข่าวสารใหม่
                 ...
                 <div class="portlet-body">
                 	...
                 	<div class="form-group">
                     	<div class="row">
                     		...
                     		<div class="col-md-3">
                     			<label>  กลุ่มที่แจ้ง  </label>
    							<select class="form-control form-control-sm" id="select_type">
  									<option value="">--- ทั้งหมด ---</option>
  									<option value="S">Supplier</option>
								</select>
                     		</div>
                     		<div class="col-md-3 div-text-supplier" style="display : none;">
                     			<label>  ชื่อซัพพลายเออร์ </label>
    							<input type="text" class="form-control input-sm" id="text_supplier">
                     		</div>
                     	</div>                     	
                     </div>                     
                     	...
                     	<div class="row">
                     		<div class="col-md-3">
    							...
    							<select class="form-control form-control-sm" id="select_status">
  									<option value="">--- ทั้งหมด ---</option>
  									<option value="1">ยังไม่ส่งข้อกำหนด/ข่าวสาร</option>
  									<option value="2">ยังไม่รับทราบ  (ยังรับทราบไม่ครบทุก Supplier)</option>
  									<option value="3">รับทราบ  (รับทราบทุก Supplier แล้ว)</option>
								</select>
                     		</div>
                     		<div class="col-md-4">
     ...
     <script src="assets/js/page_information.js" type="text/javascript"></script>   
